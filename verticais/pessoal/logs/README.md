# Logs de Execução — Triagem Pessoal

Esta pasta armazena o histórico diário de execução da triagem da **vertical Pessoal**. Cada execução gera um arquivo Markdown no formato `YYYY-MM-DD.md`.
...
```markdown
# Triagem Automática Pessoal — YYYY-MM-DD
...
- Nunca incluir nos logs dados sensíveis do colaborador (CPF/CNPJ completos, salário-base, endereços etc.). Quando necessário citar, anonimize.
