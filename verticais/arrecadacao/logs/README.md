# Logs de Execução — Triagem Arrecadação

Esta pasta armazena o histórico diário de execução da triagem da **vertical Arrecadação**. Cada execução gera um arquivo Markdown no formato `YYYY-MM-DD.md`.
...
```markdown
# Triagem Automática Arrecadação — YYYY-MM-DD
...
- **Sistema:** Tributos / e-Sfinge / Cidadão Web
- **Município:** Itajaí
...
- Nunca incluir nos logs dados sensíveis do contribuinte (CPF/CNPJ completos, valores específicos, endereços etc.). Quando necessário citar, anonimize.
