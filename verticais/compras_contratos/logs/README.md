# Logs de Execução — Triagem Compras/Contratos

Esta pasta armazena o histórico diário de execução da triagem da **vertical Compras/Contratos**. Cada execução gera um arquivo Markdown no formato `YYYY-MM-DD.md`.
...
```markdown
# Triagem Automática Compras/Contratos — YYYY-MM-DD
...
|---------|---------------|-------------------------|----------------|-------------|
| BTHSC-9999 | Dúvida / Aguardando Triagem | COMP-123 | Não iniciada | ... |
